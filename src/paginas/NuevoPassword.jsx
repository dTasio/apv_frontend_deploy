        ...
        <>
            ...
            <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
                ...
                { tokenValido && (
                    ...
                    {passwordModificado && <Link className="block text-center my-5 text-gray-500 hover:cursor-pointer hover:text-indigo-600" to="/">¿Ya tienes una cuenta? Inicia Sesión</Link>}
